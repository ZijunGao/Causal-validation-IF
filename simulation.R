...
# saveRDS(list(record.absolute.total = record.absolute.total.seq, record.relative.total = record.relative.total.seq), file.path("~/Desktop/Research/Zijun/causal validation/Causal-validation/data", paste(setting, ".rds", sep= "")))
