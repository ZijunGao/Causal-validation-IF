...
for(i in 1:length(setting.seq)){
  ...
  # LASSO
  pdf(file = paste(plotDirectory, "/", setting, " estimator error", " LASSO", ".pdf", sep = ""), width = 5, height = 3.5)
  ...
  # Boosting
  pdf(file = paste(plotDirectory, "/", setting, " estimator error", " Boosting", ".pdf", sep = ""), width = 5, height = 3.5)
  ...
  # LASSO V.S. Boosting
  pdf(file = paste(plotDirectory, "/", setting, " estimator error", " LASSO V.S. Boosting", ".pdf", sep = ""), width = 5, height = 3.5)
